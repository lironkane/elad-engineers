        ...
        <div className="translate-y-0 opacity-100 transition-all duration-1000 ease-out flex flex-col items-center text-center">
          ...
          <div className="mt-10 flex justify-center gap-6">
            <a
              ...
              className="relative overflow-hidden group inline-flex items-center px-8 py-5 bg-white/15 backdrop-blur-md text-lg font-medium rounded-lg text-white border border-primary-400/30 hover:bg-white/20 transition-all duration-300 shadow-lg"
            >
            ...
            <a
              ...
              className="relative overflow-hidden group inline-flex items-center px-8 py-5 bg-accent-600/80 backdrop-blur-md text-lg font-medium rounded-lg text-white border border-accent-400/30 hover:bg-accent-600/90 transition-all duration-300 shadow-lg"
            >
